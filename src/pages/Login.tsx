...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-10 max-w-sm w-full text-center shadow-xl">
        <div className="mb-6">
          <div className="text-4xl mb-3">💰</div>
          <h1 className="text-2xl font-bold text-white">Cash Flow</h1>
          <p className="text-gray-400 text-sm mt-2">
            Track your revenue streams and expenses in one place.
          </p>
        </div>
